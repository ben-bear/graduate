...
public class BuildIndex {
     ...
     * fileList set func
     */
    public void setFileList(List<FileDo> l) {
        fileList = l;
    }
        ...
        fileList.forEach(f -> {
            ...
            f.getKwList().forEach(kw -> {
                ...
                while (start <= kw.length()) {
                    ...
                    Integer z = RandomUtils.fp(kzSub.toString(), String.valueOf(count));
                    Integer u = RandomUtils.fp(kuSub.toString(), String.valueOf(count));
